    ...
    <div class="container">
        ...
        <div class="row sua-avaliacao">
            <div class="col-4 mt-2">
                <div class="atendimento">Preço justo</div>
            </div>
            <div class="col-8">
                <div class="estrelas">
        ...
        <!--<div class="row">
            <div class="col-4 mt-4">
                <div class="atendimento">Enviar imagem</div>
                <div>
                        ...
                        <div class="Neon-input-dragDrop">
                            <div class="Neon-input-inner">
                                ...
                                <div class="Neon-input-text">
                                    <h3><i class="material-icons">attach_file</i></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="avaliacao-atendimento">
                    <div class="row justify-content-center">
                        <div class="form-group col-12 col-lg-12">
                            <label class="avalicao-atendimento" for="comentario">deixe um comentário</label>
