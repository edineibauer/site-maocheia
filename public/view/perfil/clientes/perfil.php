<section id="topo">
    <div class="container float-left">
            <a href="#" class="float-left perfil-link" id="perfil-image" style="background-image: url('<?=HOME . VENDOR?>site-maocheia/public/assets/svg/account.svg')"></a>
            <div id="perfil-nome-block" class="pl-2">
                <a href="#" class="pl-2 perfil-link float-left">
                    <h5 id="nome-user">Usuário</h5>
                    <div id="avaliacao-perfil-profissional"></div>
                    <div id="preco-perfil-profissional"></div>
                </a>
            </div>
            <div class="hide" id="saldoProfissional">
                <div class="saldo">
